...
public class HW5Test {
    ...
    public void testCase1() {
        ...
        driver.findElement(By.xpath("//input[@name='USER_LOGIN']")).sendKeys("MikhailS06");
    ...
    public void testCase6() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='USER_PASSWORD']")).sendKeys("D2EA_7abd");
        driver.findElement(By.xpath("//button[@name='Login']")).click();
        String s = driver.findElement(By.xpath("//a[@class='nav-link text-truncate pt-0']")).getText();driver.findElement(By.xpath("//a[@href='/cabinet/']//i")).click();
        ...
        driver.findElement(By.xpath("//input[@name='NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='NAME']")).sendKeys("Михаил");
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).sendKeys("Александрович");
        driver.findElement(By.xpath("//input[@name='LAST_NAME']")).clear();
        ...
        driver.get("https://ribomaniya.ru/cabinet/personal/?"); // обновление страницы
        s = driver.findElement(By.xpath("//a[@class='nav-link text-truncate pt-0']")).getText();
        assertTrue(s.equals("Михаил")); // факт того, что параметры тестового пользователя восстановлены.
